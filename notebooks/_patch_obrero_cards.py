...
Mostrar solo metricas 2025 vs 2024.
"""
import json
...
new_source = [
    ...
    "\n",
    "# Comparacion 2025 vs 2024 (datos reales)\n",
    "año_actual = 2025\n",
    "año_anterior = 2024\n",
    ...
    "    ax.text(0.5,0.45, f'{año_actual}', ha='center', fontsize=8, color='#ADB5BD')\n",
...
print('Celda 8 (Cards) corregida: solo muestra 2025 vs 2024')
